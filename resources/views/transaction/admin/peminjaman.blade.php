...
<x-app-layout >
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto backdrop-blur-2xl sm:px-6 lg:px-8 text-sm">
            <div class="bg-white/40 backdrop-blur-md border  border-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="px-32 text-black py-8">
                    <h1
                        class="text-center bg-gradient-to-br from-blue-800 to-cyan-700 text-transparent bg-clip-text text-5xl font-mono font-extrabold pt-16 pb-8">
                        Konfirmasi Pinjaman
                    </h1>
                    <p
                        class="text-lg  bg-gradient-to-br from-sky-800 to-cyan-700 text-transparent bg-clip-text  font-extrabold font-serif">
                        Total Peminjaman: {{ $responseData['user']->where('status',0)->count() }}</p>

                    ...
                    <div class="flex justify-around">
                        ...
                        <div
                            ...
                            <div class="relative p-8 grow space-y-2">
                                ...
                                <i
                                    class=" absolute right-4 text-cyan-300/40 h-16 text-5xl z-0 top-6 fas fa-hand-holding"></i>
                                <strong
                                    class="text-4xl">{{ $transaksi->where('status', '!=', 0)->where('peminjaman.status', 1)->count() }}</strong>
                                <p class="text-lg text-wrap font-bold font-sans">Req Confirmed</p>
                            </div>

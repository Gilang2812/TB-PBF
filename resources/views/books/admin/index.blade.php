                    ...
                    <div class=" mx-8 mt-8 space-y-8">
                        <div class="flex justify-between">
                            ...
                            <form action="{{route('book.index')}}" method="GET">
                                <input type="text" class=" rounded-lg border-2 border-white bg-white/30 focus:outline-none focus:border-white placeholder:{fas fa search} " value="{{ request('search') }}" name="search">
                            ...
                            <table class="min-w-full divide-y divide-gray-200 mt-4">
                                <thead>
                                    <tr class="bg-gray-50 text-center">
                                        ...
                                        <th class="px-6 py-3 text-xs font-medium text-gray-500 uppercase">Nomor Buku
                                        </th>
                                        <th class="px-6 py-3 text-xs font-medium text-gray-500 uppercase">Judul Buku
                                        </th>
                                        ...
                                        <th class="px-6 py-3 text-xs font-medium text-gray-500 uppercase">Ketersediaan
                                        </th>
                                        <th class="px-6 py-3 text-xs font-medium text-gray-500 uppercase">Image</th>
                                        <th class="px-6 py-3 text-xs font-medium text-gray-500 uppercase" hidden>Posisi
                                        </th>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200 text-center">
                                    @foreach ($book as $buku)
                                        <tr class="hover:bg-slate-50">
                                            ...
                                            <td class="px-6 py-4">
                                                <!-- Edit button -->
                                                <a href="/book/{{ $buku->nomor_buku }}/update"
